...
public class SolicitacaoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SolicitacaoResponseDTO> atualizar(@PathVariable Long id, @RequestBody SolicitacaoDTO solicitacaoDTO) {
...
public ResponseEntity<SolicitacaoResponseDTO> atualizarStatus(@PathVariable Long id, @RequestBody StatusDTO statusDto) {
